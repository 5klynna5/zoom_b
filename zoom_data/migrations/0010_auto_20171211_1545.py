...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('zoom_data', '0009_auto_20171211_1543'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='contact',
            name='contact_pref',
            field=models.CharField(null=True, choices=[('Text', 'TEXT'), ('Mail', 'MAIL'), ('Facebook', 'FACEBOOK'), ('Call', 'CALL'), ('Email', 'EMAIL')], blank=True, max_length=8),
        ),
        migrations.AlterField(
            model_name='contact',
